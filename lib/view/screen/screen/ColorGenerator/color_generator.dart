...
class _ColorGeneratorState extends State<ColorGenerator> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const CommonText(text: "Generate Color Code", fontWeight: FontWeight.w700, fontSize: 24,),
      ),
      body: paletteGenerator != null
        ...
        child: Column(
            ...
            children: [
              ...
              CommonText(text: 'Dominant Color Hex: $hexColor', fontWeight: FontWeight.w600, fontSize: 18,),
            ]
        ),
      )
